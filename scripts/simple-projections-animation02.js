...
(function() {
	...
	loader.on('world.comparison0', function() {
		comparison0.selectAll('path')
			.attr('d', path0);
	});

	loader.on('world.comparison1', redrawComparison1);

	function redrawComparison1() {
		comparison1.selectAll('path')
			.attr('d', path1);
	}
})();
...
(function() {
	...
	var drag = d3.behavior.drag()
		.on('drag', function() {
			...
			d3.select('#rotations').selectAll('svg')
				.each(function(d) {
	...
	if (origin) drag.origin(function() {
